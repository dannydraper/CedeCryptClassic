...
;General
  ...
  ;Name and file
  Name "CedeCrypt"
  OutFile "CedeCryptSetup64bit.exe"
...
;Pages
  ...
  !insertmacro MUI_PAGE_LICENSE "C:\Data\Work\DJD\Programming\Win32Work\CedeCrypt\Installer\64bit\CCLicense.txt"
...
Section "CedeCrypt" SecDummy
  ...
  File "C:\Data\Work\DJD\Programming\Win32Work\CedeCrypt\Installer\64bit\CedeCrypt.exe"
  File "C:\Data\Work\DJD\Programming\Win32Work\CedeCrypt\Installer\64bit\CedeCryptShellx64.dll"
  File "C:\Data\Work\DJD\Programming\Win32Work\CedeCrypt\Installer\64bit\Readme.rtf"
  
  SetOutPath "$APPDATA\CedeSoft\CedeCrypt"
  File "C:\Data\Work\DJD\Programming\Win32Work\CedeCrypt\Installer\64bit\CCrypt.dll"
  ...
  Exec '"regsvr32" /s "$INSTDIR\CedeCryptShellx64.dll"'
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Exec '"regsvr32" /u /s "$INSTDIR\CedeCryptShellx64.dll"'
  ...
  Delete /REBOOTOK "$INSTDIR\CedeCryptShellx64.dll"
