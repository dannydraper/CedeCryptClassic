...
{				
	...
	m_hwndsessionlbl = CreateWindow ("static", "<Session Information>", WS_CHILD | WS_VISIBLE, 10, 100, 273, 40, hWnd, (HMENU) ID_LBLSESSIONINFO, GetModuleHandle (NULL), NULL);
